...
function Gladius:ARENA_OPPONENT_UPDATE(event, unit, type)
	...
	self.buttons[unit].spec = select(1, UnitClass(unit))
	...
	if type == "seen" then
		...
		if (unit =="arena1") and GladdyButtonFrame1 then
			if GladdyButtonFrame1 then GladdyButtonFrame1:SetAlpha(1) end
		end
		if (unit =="arena2") and GladdyButtonFrame2 then
			if GladdyButtonFrame2 then GladdyButtonFrame2:SetAlpha(1) end
		end
		if (unit =="arena3") and GladdyButtonFrame3 then
	...
	elseif type == "unseen" then
		...
		if (unit =="arena1") and GladdyButtonFrame1 then
			if GladdyButtonFrame1 then GladdyButtonFrame1:SetAlpha(0.5) end
		end
		if (unit =="arena2") and GladdyButtonFrame2 then
			if GladdyButtonFrame2 then GladdyButtonFrame2:SetAlpha(0.5) end
		end
		if (unit =="arena3") and GladdyButtonFrame3 then
			if GladdyButtonFrame3 then GladdyButtonFrame3:SetAlpha(0.5) end
		end
	-- enemy left arena
	elseif type == "destroyed" then
		self:UpdateAlpha(unit, 0.3)
		if (unit =="arena1") and GladdyButtonFrame1 then
			if GladdyButtonFrame1 then GladdyButtonFrame1:SetAlpha(0.3) end
		end
		if (unit =="arena2") and GladdyButtonFrame2 then
			if GladdyButtonFrame2 then GladdyButtonFrame2:SetAlpha(0.3) end
		end
		if (unit =="arena3") and GladdyButtonFrame3 then
			if GladdyButtonFrame3 then GladdyButtonFrame3:SetAlpha(0.3) end
		end
	-- arena over
...
function Gladius:UpdateUnit(unit, module, ArenaSeen)
	local _, instanceType = IsInInstance()
...
function Gladius:CreateButton(unit)
	...
	-- secure
	--local secure = CreateFrame("Button", "GladiusButton"..unit, button, "ActionButtonTemplate")
