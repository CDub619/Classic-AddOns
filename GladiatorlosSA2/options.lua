					...
					spellAuraApplied = {
						...
						args = {
							...
							generalaura = { --AuraApplied
								...
								order = 30,					      		
								args = listOption({54861,54758,195901,214027,34709,44055},"auraApplied"),
							},
							...
							druid = { -- AuraApplied
								...
								order = 70,
								args = listOption({16870,22812,29166,53312,53201,50334,5229,22842,52610,61336,69369,17116,48518,48517},"auraApplied"),
							},
							hunter = { -- AuraApplied
								type = 'group',
								inline = true,
								...
								order = 80,
								args = listOption({34027,54216,34471,3045,19263,35079,19574,19577, 53476, 53479, 61684},"auraApplied"),
							},
							mage = { -- AuraApplied
								type = 'group',
								inline = true,
							...
							paladin = { -- AuraApplied
								...
								order = 110,
								args = listOption({1044,498,31821,10278,642,31884,6940,6940,1038,20216,20375,31842,20178,10308,54428,53563,53601, 54149, 59578},"auraApplied"),
							},
							priest	= { -- AuraApplied
								type = 'group',
								inline = true,
								...
								order = 120,
								args = listOption({33206,10060,6346,14751,15286,552,47788,47585,48066,586,15473,48168},"auraApplied"),
							},
							rogue = { -- AuraApplied
								type = 'group',
								inline = true,
							...
							warlock	= { -- AuraApplied
								...
								order = 150,
								args = listOption({132,47891,18708,47241,17941,54277},"auraApplied"),
							},
							warrior	= { -- AuraApplied
								type = 'group',
								inline = true,
								...
								order = 160,
								args = listOption({55694,46924,2687,871,18499,1719,23920,12292,12975,20230,23881,60503,2565 },"auraApplied"),
							},
							dk	= {
								type = 'group',
								inline = true,
					...
					spellAuraRemoved = {
						...
						args = {
							...
							druid = { -- AuraRemoved
								...
								name = L["|cffFF7D0ADruid|r"],
								order = 60,
								args = listOption({22812,29166,53312,53201,50334,33357,5229,22842,52610,61336,69369,17116,16870,48518,48517},"auraRemoved"),
							},
							hunter = { -- AuraRemoved
								type = 'group',
								inline = true,
...
--[[							enemyInterrupts = { -- CastSuccess
							...
							druid = { -- CastSuccess
								...
								name = L["|cffFF7D0ADruid|r"],
								order = 70,
								args = listOption({8946,2782,8983,9913,33357,770,16857,33831,26983,18562,53201,16979,49376,49802,49803,2893, 64205},"castSuccess"),
							},
							hunter = { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["|cffABD473Hunter|r"],
								order = 80,
								args = listOption({5116,1543,14325,14311,34490,23989,49010,19503,27019,49050,13810,60192,19801,3034,23989,53271,781,34600,53547,53209,58434,19885,19883},"castSuccess"),
							},
							mage = { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["|cff69CCF0Mage|r"],
								order = 90,
								args = listOption({475,1953,2139,45438,42917,66,30449,11113,11958,31687,44445,44572,12051,42987,55342,475,42950,33395,55360},"castSuccess"),
							},
							paladin = { -- CastSuccess
								type = 'group',
								inline = true,
							...
							shaman	= { -- CastSuccess
								...
								name = L["|cff0070daShaman|r"],
								order = 140,
								args = listOption({2484,8143,2870,8166,8177,8012,49231,8170,2062,2894,2825,32182,16190,8143,51533,59159,51886,8170,61657,49233,57994},"castSuccess"),
							},
--[[							shamanTotems	= { -- CastSuccess
							...
							warlock = { -- CastSuccess
								...
								name = L["|cff9482C9Warlock|r"],
								order = 150,
								args = listOption({17928,19647,47860,47847,48011,47875,48020,6358,11719},"castSuccess"),
							},
							warrior	= { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["|cffC79C6EWarrior|r"],
								order = 160,
								args = listOption({676,5246,6552,72,29704,11578,20252,3411,12328,12809,2457,71,2458,57755,57823,46968,7386,7384},"castSuccess"),
							},
							dk	= {
								type = 'group',
								inline = true,
								name = "|cffC41F3BDeath Knight|r",
								order = 170,
								args = listOption({49941,48266,48263,48265,49005,48982,47476,45524,47568,49203,47528,49938,49576,61999,46584,49206,47481,48743,51328},"castSuccess"),
							},
							racials = {
								type = 'group',
								inline = true,
